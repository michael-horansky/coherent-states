...
bose_hubbard = UNDASDB("UNDASDB_M=2_S=10")
#bose_hubbard.load_data()

bose_hubbard.set_global_parameters(M = 2, S = 20)
bose_hubbard.set_hamiltonian_tensors(A_BH, B_BH)
...
bose_hubbard.simulate_uncoupled_basis(max_t = 2.0, N_dtp = 200, rtol = (1e-10, 1e-10), reg_timescale = (1e-2, 1e-5)) # (1e-2, 1e-5)
