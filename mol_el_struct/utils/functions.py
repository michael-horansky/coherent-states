...
#------------------------------------------------------------------------------
#----------------------- Methods for occupancy indices ------------------------
#------------------------------------------------------------------------------

"""def occ_string_to_index(N_orb, S_A, S_B, occ_string_A, occ_string_B):

    return( int(occ_string_A, 2) * math.comb(N_orb, S_B) + int(occ_string_B, 2) )

def index_to_occ_string(N_orb, S_A, S_B, i):

    int_B = i % math.comb(N_orb, S_B)
    int_A = i // math.comb(N_orb, S_B)

    return("{b:0}".format(int_A), "{b:0}".format(int_B))"""
