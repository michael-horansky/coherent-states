...
for mol_name, mol in benchmark_molecules.items():
    ...
    mol_solver = ground_state_solver(f"{mol_name}_UHF_LEGS_SE_with_SCF")
    ...
    mol_solver.find_ground_state("LE_first_order", N = 25, N_sub = 5, sigma = 0.05, dataset_label = "LEGS 1st o.")
